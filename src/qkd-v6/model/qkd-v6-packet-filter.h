...
#ifndef QKD_V6_PACKET_FILTER_H
#define QKD_V6_PACKET_FILTER_H
...
/**
 * \ingroup qkd
 * \class QKDv6PacketFilter
 * \brief QKDv6PacketFilter is the abstract base class for filters defined for IPv4 packets.
 */
class QKDv6PacketFilter: public PacketFilter {
public:
  /**
...
/**
 * \ingroup qkd
 * \class PfifoFastQKDv6PacketFilter
...
class PfifoFastQKDv6PacketFilter: public QKDv6PacketFilter {
public:
  /**
   * \brief Get the type ID.
   * \return the object TypeId
  ...
  PfifoFastQKDv6PacketFilter ();
  virtual ~PfifoFastQKDv6PacketFilter ();

  /**
   * \brief Enumeration of modes of Ipv4 header traffic class semantics
   */
  enum QKDv6TrafficClassMode
  {
...
private:
  ...
  QKDv6TrafficClassMode m_trafficClassMode; //!< traffic class mode
};
