...
#ifndef QKD_V6_TOTAL_GRAPH_H
#define QKD_V6_TOTAL_GRAPH_H
...
/**
 * \ingroup qkd
 * \class QKDv6TotalGraph
 * \brief QKDv6TotalGraph is implemented to allow easier access to the state of ALL QKD buffers and easier 
 * monitoring of the overall key material consumption. 
 *
 *  QKDv6TotalGraph is used to show the overall consumption of key material in QKD Network. 
 *	QKD Total Graph is updated each time when key material is generated or consumed on a 
 *	network link. Only one QKDv6TotalGraph in the whole simulation is allowed!
 */
class QKDv6TotalGraph : public Object 
{
public:
