...
#ifndef QKD_V6_MANAGER_H
#define QKD_V6_MANAGER_H
...
namespace ns3 {
     ...
     *
     */
    class QKDv6Manager : public Object {
    public:
        ...
        *    @param     Ptr<QKDv6NetDevice>
        *    @param     Ptr<QKDv6NetDevice>
        *    @param     Ptr<NetDevice>
        *    @param     Ptr<NetDevice>
        *    @param     Ptr<QKDv6Crypto>
        *    @param     Ptr<Socket>
        *    @param     Ipv6InterfaceAddress
        *    @param     Ipv6InterfaceAddress
        *    @param     Ipv6InterfaceAddress
        *    @param     Ipv6InterfaceAddress
        *    @param     bool
        ...
        */
        void AddNewLink ( 
            Ptr<QKDv6NetDevice>       NetDeviceSrc,
            Ptr<QKDv6NetDevice>       NetDeviceDst,
            Ptr<NetDevice>          IPNetDeviceSrc,
            Ptr<NetDevice>          IPNetDeviceDst,
            Ptr<QKDv6Crypto>          Crypto,
            Ptr<Socket>             socket,
        ...
        /**
        * \brief Called from QKDv6Manager::VirtualReceive
        ...
        */
        ...
        /**
        * \brief Called from QKDv6Manager::VirtualSend
        ...
        * This function needs to check the status of QKDv6Buffer. 
        * According to the information obtained, packet from corresponding queue will be served
        * @param Ptr<NetDevice> QKDv6NetDevice
        */
        ...
        * \return uint32_t
        */
        uint32_t FetchMaxNumberOfRecordedKeyChargingTimePeriods (Ipv6Address nextHop);
    
        /**
        *   \brief Forward packet from underlay network through the socket to the QKDv6NetDevice
        ...
        *   Function calls QKDv6Crypto to which QKDv6Buffer is forwarded as parameter. QKDv6Crypto is in 
        *   charge to analyze the packet's requirements and QKDv6Buffer status.
        *   @param Ptr<Packet>
        *   @param Ipv6Address
        *   @uint32_t 
        *   @return bool
        */
        ...
        /**
        *   \brief Help function that returns QKDv6Buffer Position in m_buffers on the basis of source IPv6Address
        *   @Ipv6Address
        *   @return uint32_t
        */
        ...
        /**
        *   \brief Return QKDv6Buffer by the buffer position. Usually called from QKDGraphManager
        *   @param uint32_t bufferId
        *   @return Ptr<QKDv6Buffer>
        */
        Ptr<QKDv6Buffer> GetBufferByBufferPosition (const uint32_t& index);

        /**
        *   \brief Return QKDv6Buffer Position in m_buffers on the basis of source IPv6Address
        *   @param  Address
        *   @return Ptr<QKDv6Buffer>
        */
        Ptr<QKDv6Buffer> GetBufferBySourceAddress (const Address& sourceAddress);

        /**
        *   \brief Get connection details based on destination IPv6Address
        *   @param Ipv6Address
        *   @return QKDv6Manager::Connection
        */
        QKDv6Manager::Connection GetConnectionDetails (const uint32_t& bufferId);

        /**
        *   \brief Return QKDv6BufferID on the basis of destination IPv6Address
        *   @Ipv6Address
        *   @return uint32_t
        */
        QKDv6Manager::Connection GetConnectionDetails (const Address sourceAddress);
        ...
        *   @return std::map<Ipv6Address, Ipv6Address>
        */
        std::vector<QKDv6Manager::addressGroup > GetMapOfSourceDestinationAddresses();
        ...
        *   \brief Help function
        */
        std::map<Address, QKDv6Manager::Connection >::iterator FetchConnection(const Address sourceAddress);

        /**
        *   \brief Fetch performances of the public channel. 
        */
        double  FetchPublicChannelPerformance (Ipv6Address nextHop);
    ...
    private:  
        ...
        */
        ...
        std::vector<Ptr<QKDv6Buffer> > m_buffers; //<!  Buffers associated to this QKD manager
