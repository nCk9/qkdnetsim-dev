...
#ifndef QKD_V6_GRAPH_MANAGER_H
#define QKD_V6_GRAPH_MANAGER_H
...
#include "qkd-v6-graph.h" 
#include "qkd-v6-total-graph.h" 

namespace ns3 {
 
/**
 * \ingroup qkd
 * \class QKDv6GraphManager
 * \brief QKDv6GraphManager. 
 *
 *  QKDv6GraphManager is a signleton class used to connect QKDv6Graphs and QKDv6TotalGraph
...
class QKDv6GraphManager : public Object 
{
public:
    ...
    * 	\brief Destructor 
    */
	virtual ~QKDv6GraphManager(); 

    /**
    * 	\brief Signelton getInstance function 
    */
	static QKDv6GraphManager* getInstance();
    ...
    */
    ...
    /**
    * 	\brief Connect new QKDBuffer to QKDv6TotalGraph
    ...
    */
    ...
    /**
    * 	\brief Return Ptr to QKDv6TotalGraph 
    *	@return Ptr<QKDv6TotalGraph>
    */
	Ptr<QKDv6TotalGraph> GetTotalGraph(); 
...
private:  
	...
	static QKDv6GraphManager *single; 

	static Ptr<QKDv6TotalGraph> m_totalGraph; //!< Ptr to QKDv6TotalGraph
	
	std::vector<std::vector<QKDv6Graph *> > m_graphs; //vector of nodes-device-channels 
};
}
