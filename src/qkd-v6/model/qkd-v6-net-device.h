...
#ifndef QKD_V6_NET_DEVICE_H
#define QKD_V6_NET_DEVICE_H
 ...
 *
 * A QKDv6NetDevice is a "virtual" NetDevice implementation which
 ...
 * QKDv6NetDevice.  Together, these features allow one to build tunnels.
 ...
 * directly.  However, QKDv6NetDevice is usually much simpler to program
 * than a NetDevice subclass. 
 * 
 * \note QKDv6NetDevices are used only for overlay implementation of 
 *  the QKD network.
 */
class QKDv6NetDevice : public NetDevice
{
public:
  /**
   * Callback the be invoked when the QKDv6NetDevice is asked to queue/transmit a packet.
