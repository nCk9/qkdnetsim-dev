...
class QKDv6Key : public Object
{
    public:
        ...
        * by getUid).
        */
        QKDv6Key (uint32_t keyID, uint32_t keySize); 
    ...
    private:
        ...
        uint32_t            m_id;       //<! QKDv6KeyID
        static uint32_t     m_globalUid; //<! Global static QKDv6KeyID
        uint32_t            m_size; //<! QKDv6Key size
        std::string         m_key;  //<! QKDv6Key raw value
        Time                m_timestamp; //<! QKDv6Key generation timestamp 
