...
NS_LOG_COMPONENT_DEFINE ("QKDv6TotalGraph");

NS_OBJECT_ENSURE_REGISTERED (QKDv6TotalGraph);

TypeId QKDv6TotalGraph::GetTypeId (void) 
{
  static TypeId tid = TypeId ("ns3::QKDv6TotalGraph")
    .SetParent<Object> () 
    ; 
  return tid;
}
 
QKDv6TotalGraph::~QKDv6TotalGraph(){}
...
void
QKDv6TotalGraph::ProcessMCurrent(uint32_t newValue, char sign){ 
...
void
QKDv6TotalGraph::ProcessMThr(uint32_t newValue, char sign){ 
