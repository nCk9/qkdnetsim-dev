...
int main (int argc, char *argv[])
{
    ...
    std::cout << "Source IP address: " << i0i1.GetLinkLocalAddress(0) << std::endl;
    std::cout << "Destination IP address: " << i1i2.GetLinkLocalAddress(1) << std::endl;

    /* QKD APPs for charing  */
    QKDAppChargingHelper qkdChargingApp("ns3::TcpSocketFactory", i0i1.GetLinkLocalAddress(0),  i0i1.GetLinkLocalAddress(1), 3072000);
