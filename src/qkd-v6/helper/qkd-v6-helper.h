 ...
 * "mixins".
 */
class QKDv6Helper : public PcapHelperForDevice,
...
public:
    ...
    * QKDv6NetDevice created through QKDv6Helper::Install.
    */
    ...
    *
    * Set these attributes on each ns3::QKDv6NetDevice created
    * by QKDv6Helper::Install
    */
    ...
    * \param value the value of the attribute to set
    *
    * Set these attribute on each ns3::QKDv6Channel created
    * by QKDv6Helper::Install
    */
    ...
    *
    * This method creates a ns3::QKDv6Channel with the
    * attributes configured by QKDv6Helper::SetChannelAttribute,
    * then, for each node in the input container, we create a 
    * ns3::QKDv6NetDevice with the requested attributes, 
    * a queue for this ns3::NetDevice, and associate the resulting 
    * ns3::NetDevice with the ns3::Node and ns3::QKDv6Channel.
    */
    ...
    */
    NetDeviceContainer InstallOverlayQKD (
        Ptr<NetDevice>          IPa,
        Ptr<NetDevice>          IPb,
        Ipv6InterfaceAddress    da,
        Ipv6InterfaceAddress    db, 
        uint32_t                Mmin,
        uint32_t                Mthr,
        uint32_t                Mmax,
        uint32_t                Mcurrent,
    ...
    * an object of type ns3::Ipv6RoutingProtocol per node. This routing
    * object is then associated to a single ns3::Ipv6 object through its 
    * ns3::Ipv6::SetRoutingProtocol.
    */
