 ...
 */
#ifndef QKD_SINK_APP_HELPER_H
#define QKD_SINK_APP_HELPER_H
 ...
 * on a set of nodes.
 */
class QKDSinkAppHelper
{
public:
  /**
   * Create a QKDSinkAppHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  QKDSinkAppHelper (std::string protocol, Address address);
