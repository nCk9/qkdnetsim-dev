...
#ifndef VIRTUAL_IPV6_L3_PROTOCOL_H
#define VIRTUAL_IPV6_L3_PROTOCOL_H
 ...
 * the packet.
 */
class VirtualIpv6L3Protocol : public Ipv6
{
public:
  /** 
   ...
   * \brief Constructor.
   */
  VirtualIpv6L3Protocol ();

  /**
   * \brief Destructor.
   */
  virtual ~VirtualIpv6L3Protocol ();
...
private:
  /**
   * \brief VirtualIpv6L3ProtocolTestCase test case.
   * \relates VirtualIpv6L3ProtocolTestCase
   */
  friend class VirtualIpv6L3ProtocolTestCase;
  /**
   ...
   */
  VirtualIpv6L3Protocol (const VirtualIpv6L3Protocol&);
   ...
   */
  VirtualIpv6L3Protocol &operator = (const VirtualIpv6L3Protocol&);
