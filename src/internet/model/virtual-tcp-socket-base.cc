 ...
 *
 * Author: Miralem Mehic <miralem.mehic@ieee.org after Adrian Sai-wah Tam <adrian.sw.tam@gmail.com>
 */
...
NS_LOG_COMPONENT_DEFINE ("VirtualTcpSocketBase");

NS_OBJECT_ENSURE_REGISTERED (VirtualTcpSocketBase);

TypeId
VirtualTcpSocketBase::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::VirtualTcpSocketBase")
    .SetParent<TcpSocket> ()
    .SetGroupName ("Internet")
    .AddConstructor<VirtualTcpSocketBase> ()
//    .AddAttribute ("TcpState", "State in TCP state machine",
//                   TypeId::ATTR_GET,
//                   EnumValue (CLOSED),
//                   MakeEnumAccessor (&VirtualTcpSocketBase::m_state),
//                   MakeEnumChecker (CLOSED, "Closed"))
    .AddAttribute ("MaxSegLifetime",
                   ...
                   MakeDoubleAccessor (&VirtualTcpSocketBase::m_msl),
                   MakeDoubleChecker<double> (0))
    .AddAttribute ("MaxWindowSize", "Max size of advertised window",
                   UintegerValue (65535),
                   MakeUintegerAccessor (&VirtualTcpSocketBase::m_maxWinSize),
                   MakeUintegerChecker<uint16_t> ())
    .AddAttribute ("IcmpCallback", "Callback invoked whenever an icmp error is received on this socket.",
                   CallbackValue (),
                   MakeCallbackAccessor (&VirtualTcpSocketBase::m_icmpCallback),
                   MakeCallbackChecker ())
    .AddAttribute ("IcmpCallback6", "Callback invoked whenever an icmpv6 error is received on this socket.",
                   CallbackValue (),
                   MakeCallbackAccessor (&VirtualTcpSocketBase::m_icmpCallback6),
                   MakeCallbackChecker ())
    .AddAttribute ("WindowScaling", "Enable or disable Window Scaling option",
                   BooleanValue (true),
                   MakeBooleanAccessor (&VirtualTcpSocketBase::m_winScalingEnabled),
                   MakeBooleanChecker ())
    .AddAttribute ("Sack", "Enable or disable Sack option",
                   BooleanValue (true),
                   MakeBooleanAccessor (&VirtualTcpSocketBase::m_sackEnabled),
                   MakeBooleanChecker ())
    .AddAttribute ("Timestamp", "Enable or disable Timestamp option",
                   BooleanValue (true),
                   MakeBooleanAccessor (&VirtualTcpSocketBase::m_timestampEnabled),
                   MakeBooleanChecker ())
    .AddAttribute ("MinRto",
                   ...
                   MakeTimeAccessor (&VirtualTcpSocketBase::SetMinRto,
                                     &VirtualTcpSocketBase::GetMinRto),
                   MakeTimeChecker ())
    .AddAttribute ("ClockGranularity",
                   ...
                   MakeTimeAccessor (&VirtualTcpSocketBase::SetClockGranularity,
                                     &VirtualTcpSocketBase::GetClockGranularity),
                   MakeTimeChecker ())
    .AddAttribute ("TxBuffer",
                   "TCP Tx buffer",
                   PointerValue (),
                   MakePointerAccessor (&VirtualTcpSocketBase::GetTxBuffer),
                   MakePointerChecker<TcpTxBuffer> ())
    .AddAttribute ("RxBuffer",
                   "TCP Rx buffer",
                   PointerValue (),
                   MakePointerAccessor (&VirtualTcpSocketBase::GetRxBuffer),
                   MakePointerChecker<TcpRxBuffer> ())
    .AddAttribute ("ReTxThreshold", "Threshold for fast retransmit",
                   UintegerValue (3),
                   MakeUintegerAccessor (&VirtualTcpSocketBase::SetRetxThresh,
                                         &VirtualTcpSocketBase::GetRetxThresh),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("LimitedTransmit", "Enable limited transmit",
                   BooleanValue (true),
                   MakeBooleanAccessor (&VirtualTcpSocketBase::m_limitedTx),
                   MakeBooleanChecker ())
    .AddAttribute ("EcnMode", "Determines the mode of ECN",
                   EnumValue (EcnMode_t::NoEcn),
                   MakeEnumAccessor (&VirtualTcpSocketBase::m_ecnMode),
                   MakeEnumChecker (EcnMode_t::NoEcn, "NoEcn",
                                    EcnMode_t::ClassicEcn, "ClassicEcn"))
    .AddTraceSource ("RTO",
                     "Retransmission timeout",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_rto),
                     "ns3::TracedValueCallback::Time")
    .AddTraceSource ("RTT",
                     "Last RTT sample",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_lastRttTrace),
                     "ns3::TracedValueCallback::Time")
    .AddTraceSource ("NextTxSequence",
                     "Next sequence number to send (SND.NXT)",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_nextTxSequenceTrace),
                     "ns3::SequenceNumber32TracedValueCallback")
    .AddTraceSource ("HighestSequence",
                     "Highest sequence number ever sent in socket's life time",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_highTxMarkTrace),
                     "ns3::TracedValueCallback::SequenceNumber32")
    .AddTraceSource ("State",
                     "TCP state",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_state),
                     "ns3::TcpStatesTracedValueCallback")
    .AddTraceSource ("CongState",
                     "TCP Congestion machine state",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_congStateTrace),
                     "ns3::TcpSocketState::TcpCongStatesTracedValueCallback")
    .AddTraceSource ("EcnState",
                     "Trace ECN state change of socket",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_ecnStateTrace),
                     "ns3::TcpSocketState::EcnStatesTracedValueCallback")
    .AddTraceSource ("AdvWND",
                     "Advertised Window Size",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_advWnd),
                     "ns3::TracedValueCallback::Uint32")
    .AddTraceSource ("RWND",
                     "Remote side's flow control window",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_rWnd),
                     "ns3::TracedValueCallback::Uint32")
    .AddTraceSource ("BytesInFlight",
                     "Socket estimation of bytes in flight",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_bytesInFlightTrace),
                     "ns3::TracedValueCallback::Uint32")
    .AddTraceSource ("HighestRxSequence",
                     "Highest sequence number received from peer",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_highRxMark),
                     "ns3::TracedValueCallback::SequenceNumber32")
    .AddTraceSource ("HighestRxAck",
                     "Highest ack received from peer",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_highRxAckMark),
                     "ns3::TracedValueCallback::SequenceNumber32")
    .AddTraceSource ("CongestionWindow",
                     "The TCP connection's congestion window",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_cWndTrace),
                     "ns3::TracedValueCallback::Uint32")
    .AddTraceSource ("CongestionWindowInflated",
                     "The TCP connection's congestion window inflates as in older RFC",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_cWndInflTrace),
                     "ns3::TracedValueCallback::Uint32")
    .AddTraceSource ("SlowStartThreshold",
                     "TCP slow start threshold (bytes)",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_ssThTrace),
                     "ns3::TracedValueCallback::Uint32")
    .AddTraceSource ("Tx",
                     "Send tcp packet to IP protocol",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_txTrace),
                     "ns3::VirtualTcpSocketBase::TcpTxRxTracedCallback")
    .AddTraceSource ("Rx",
                     "Receive tcp packet from IP protocol",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_rxTrace),
                     "ns3::VirtualTcpSocketBase::TcpTxRxTracedCallback")
    .AddTraceSource ("EcnEchoSeq",
                     "Sequence of last received ECN Echo",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_ecnEchoSeq),
                     "ns3::SequenceNumber32TracedValueCallback")
    .AddTraceSource ("EcnCeSeq",
                     "Sequence of last received CE ",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_ecnCESeq),
                     "ns3::SequenceNumber32TracedValueCallback")
    .AddTraceSource ("EcnCwrSeq",
                     "Sequence of last received CWR",
                     MakeTraceSourceAccessor (&VirtualTcpSocketBase::m_ecnCWRSeq),
                     "ns3::SequenceNumber32TracedValueCallback")
  ;
  return tid;
}
...
TypeId
VirtualTcpSocketBase::GetInstanceTypeId () const
{
  return VirtualTcpSocketBase::GetTypeId ();
}

VirtualTcpSocketBase::VirtualTcpSocketBase (void)
  : TcpSocket ()
{
  ...
  m_pacingTimer.SetFunction (&VirtualTcpSocketBase::NotifyPacingPerformed, this);

  bool ok;

  ok = m_tcb->TraceConnectWithoutContext ("CongestionWindow",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateCwnd, this));
  NS_ASSERT (ok == true);

  ok = m_tcb->TraceConnectWithoutContext ("CongestionWindowInflated",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateCwndInfl, this));
  NS_ASSERT (ok == true);

  ok = m_tcb->TraceConnectWithoutContext ("SlowStartThreshold",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateSsThresh, this));
  NS_ASSERT (ok == true);

  ok = m_tcb->TraceConnectWithoutContext ("CongState",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateCongState, this));
  NS_ASSERT (ok == true);

  ok = m_tcb->TraceConnectWithoutContext ("EcnState",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateEcnState, this));
  NS_ASSERT (ok == true);

  ok = m_tcb->TraceConnectWithoutContext ("NextTxSequence",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateNextTxSequence, this));
  NS_ASSERT (ok == true);

  ok = m_tcb->TraceConnectWithoutContext ("HighestSequence",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateHighTxMark, this));
  NS_ASSERT (ok == true);

  ok = m_tcb->TraceConnectWithoutContext ("BytesInFlight",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateBytesInFlight, this));
  NS_ASSERT (ok == true);

  ok = m_tcb->TraceConnectWithoutContext ("RTT",
                                          MakeCallback (&VirtualTcpSocketBase::UpdateRtt, this));
  NS_ASSERT (ok == true);
}

VirtualTcpSocketBase::VirtualTcpSocketBase (const VirtualTcpSocketBase& sock)
  : TcpSocket (sock),
  ...
  if (m_endPoint != nullptr)
    {
       ...
       * DestroyCallback is set to VirtualTcpSocketBase::Destroy. If we called
       * m_tcp->DeAllocate, it will destroy its Ipv4EndpointDemux::DeAllocate,
       * which in turn destroys my m_endPoint, and in turn invokes
       * VirtualTcpSocketBase::Destroy to nullify m_node, m_endPoint, and m_tcp.
       */
...
void
VirtualTcpSocketBase::SetNode (Ptr<Node> node)
{
  m_node = node;
}
...
void
VirtualTcpSocketBase::SetTcp (Ptr<VirtualTcpL4Protocol> tcp)
{
  m_tcp = tcp;
}
...
void
VirtualTcpSocketBase::SetRtt (Ptr<RttEstimator> rtt)
{
  m_rtt = rtt;
}
...
VirtualTcpSocketBase::GetErrno (void) const
{
  return m_errno;
}
...
VirtualTcpSocketBase::GetSocketType (void) const
{
...
Ptr<Node>
VirtualTcpSocketBase::GetNode (void) const
{
  return m_node;
}

/* Inherit from Socket class: Bind socket to an end-point in VirtualTcpL4Protocol */
int
VirtualTcpSocketBase::Bind (void)
{
  NS_LOG_FUNCTION (this);
...
int
VirtualTcpSocketBase::Bind6 (void)
{
  NS_LOG_FUNCTION (this);
...
/* Inherit from Socket class: Bind socket (with specific address) to an end-point in VirtualTcpL4Protocol */
int
VirtualTcpSocketBase::Bind (const Address &address)
{
  ...
  NS_LOG_LOGIC ("VirtualTcpSocketBase " << this << " got an endpoint: " << m_endPoint);

  return SetupCallback ();
}

void
VirtualTcpSocketBase::SetInitialSSThresh (uint32_t threshold)
{
  NS_ABORT_MSG_UNLESS ( (m_state == CLOSED) || threshold == m_tcb->m_initialSsThresh,
                        "VirtualTcpSocketBase::SetSSThresh() cannot change initial ssThresh after connection started.");

  m_tcb->m_initialSsThresh = threshold;
}

uint32_t
VirtualTcpSocketBase::GetInitialSSThresh (void) const
{
  return m_tcb->m_initialSsThresh;
}

void
VirtualTcpSocketBase::SetInitialCwnd (uint32_t cwnd)
{
  NS_ABORT_MSG_UNLESS ( (m_state == CLOSED) || cwnd == m_tcb->m_initialCWnd,
                        "VirtualTcpSocketBase::SetInitialCwnd() cannot change initial cwnd after connection started.");

  m_tcb->m_initialCWnd = cwnd;
}

uint32_t
VirtualTcpSocketBase::GetInitialCwnd (void) const
{
...
int
VirtualTcpSocketBase::Listen (void)
{
  NS_LOG_FUNCTION (this);
...
int
VirtualTcpSocketBase::Close (void)
{
  NS_LOG_FUNCTION (this);
  /// \internal
...
int
VirtualTcpSocketBase::ShutdownSend (void)
{
  NS_LOG_FUNCTION (this);
...
int
VirtualTcpSocketBase::ShutdownRecv (void)
{
  NS_LOG_FUNCTION (this);
  m_shutdownRecv = true;
  return 0;
...
int
VirtualTcpSocketBase::Send (Ptr<Packet> p, uint32_t flags)
{
  NS_LOG_FUNCTION (this << p);
  NS_ABORT_MSG_IF (flags, "use of flags is not supported in VirtualTcpSocketBase::Send()");
          ...
          if (!m_sendPendingDataEvent.IsRunning ())
            {
              m_sendPendingDataEvent = Simulator::Schedule (TimeStep (1),
                                                            &VirtualTcpSocketBase::SendPendingData,
                                                            this, m_connected);
            }
        }
      return p->GetSize ();
...
/* Inherit from Socket class: In VirtualTcpSocketBase, it is same as Send() call */
int
VirtualTcpSocketBase::SendTo (Ptr<Packet> p, uint32_t flags, const Address &address)
{
  NS_UNUSED (address);
...
Ptr<Packet>
VirtualTcpSocketBase::Recv (uint32_t maxSize, uint32_t flags)
{
  NS_LOG_FUNCTION (this);
  NS_ABORT_MSG_IF (flags, "use of flags is not supported in VirtualTcpSocketBase::Recv()");
...
Ptr<Packet>
VirtualTcpSocketBase::RecvFrom (uint32_t maxSize, uint32_t flags, Address &fromAddress)
{
...
uint32_t
VirtualTcpSocketBase::GetTxAvailable (void) const
{
  NS_LOG_FUNCTION (this);
...
uint32_t
VirtualTcpSocketBase::GetRxAvailable (void) const
{
  NS_LOG_FUNCTION (this);
...
int
VirtualTcpSocketBase::GetSockName (Address &address) const
{
  NS_LOG_FUNCTION (this);
  if (m_endPoint != nullptr)
    {
...
int
VirtualTcpSocketBase::GetPeerName (Address &address) const
{
  NS_LOG_FUNCTION (this << address);
...
void
VirtualTcpSocketBase::BindToNetDevice (Ptr<NetDevice> netdevice)
{
...
int
VirtualTcpSocketBase::SetupCallback (void)
{
  NS_LOG_FUNCTION (this);
  ...
  if (m_endPoint != nullptr)
    {
      m_endPoint->SetRxCallback (MakeCallback (&VirtualTcpSocketBase::ForwardUp, Ptr<VirtualTcpSocketBase> (this)));
      m_endPoint->SetIcmpCallback (MakeCallback (&VirtualTcpSocketBase::ForwardIcmp, Ptr<VirtualTcpSocketBase> (this)));
      m_endPoint->SetDestroyCallback (MakeCallback (&VirtualTcpSocketBase::Destroy, Ptr<VirtualTcpSocketBase> (this)));
    }
  if (m_endPoint6 != nullptr)
    {
      m_endPoint6->SetRxCallback (MakeCallback (&VirtualTcpSocketBase::ForwardUp6, Ptr<VirtualTcpSocketBase> (this)));
      m_endPoint6->SetIcmpCallback (MakeCallback (&VirtualTcpSocketBase::ForwardIcmp6, Ptr<VirtualTcpSocketBase> (this)));
      m_endPoint6->SetDestroyCallback (MakeCallback (&VirtualTcpSocketBase::Destroy6, Ptr<VirtualTcpSocketBase> (this)));
    }
...
int
VirtualTcpSocketBase::DoConnect (void)
{
  NS_LOG_FUNCTION (this);
...
int
VirtualTcpSocketBase::DoClose (void)
{
  NS_LOG_FUNCTION (this);
  switch (m_state)
    {
...
void
VirtualTcpSocketBase::CloseAndNotify (void)
{
  NS_LOG_FUNCTION (this);
...
/* Tell if a sequence number range is out side the range that my rx buffer can
    accpet */
bool
VirtualTcpSocketBase::OutOfRange (SequenceNumber32 head, SequenceNumber32 tail) const
{
...
void
VirtualTcpSocketBase::ForwardUp (Ptr<Packet> packet, Ipv4Header header, uint16_t port,
...
void
VirtualTcpSocketBase::ForwardUp6 (Ptr<Packet> packet, Ipv6Header header, uint16_t port,
...
void
VirtualTcpSocketBase::ForwardIcmp (Ipv4Address icmpSource, uint8_t icmpTtl,
...
void
VirtualTcpSocketBase::ForwardIcmp6 (Ipv6Address icmpSource, uint8_t icmpTtl,
                             uint8_t icmpType, uint8_t icmpCode,
                             uint32_t icmpInfo)
{
  NS_LOG_FUNCTION (this << icmpSource << static_cast<uint32_t> (icmpTtl) <<
...
bool
VirtualTcpSocketBase::IsValidTcpSegment (const SequenceNumber32 seq, const uint32_t tcpHeaderSize,
...
void
VirtualTcpSocketBase::DoForwardUp (Ptr<Packet> packet, const Address &fromAddress,
                            const Address &toAddress)
{
  ...
  if (m_rWnd.Get () == 0 && m_persistEvent.IsExpired ())
    { // Zero window: Enter persist state to send 1 byte to probe
      ...
      m_persistEvent = Simulator::Schedule (m_persistTimeout, &VirtualTcpSocketBase::PersistTimeout, this);
...
void
VirtualTcpSocketBase::ProcessEstablished (Ptr<Packet> packet, const TcpHeader& tcpHeader)
{
...
bool
VirtualTcpSocketBase::IsTcpOptionEnabled (uint8_t kind) const
{
...
void
VirtualTcpSocketBase::ReadOptions (const TcpHeader &tcpHeader, bool &scoreboardUpdated)
{
  NS_LOG_FUNCTION (this << tcpHeader);
...
void
VirtualTcpSocketBase::EnterRecovery ()
{
  NS_LOG_FUNCTION (this);
...
void
VirtualTcpSocketBase::ReceivedAck (Ptr<Packet> packet, const TcpHeader& tcpHeader)
{
  NS_LOG_FUNCTION (this << tcpHeader);
...
void
VirtualTcpSocketBase::ProcessAck (const SequenceNumber32 &ackNumber, bool scoreboardUpdated,
...
void
VirtualTcpSocketBase::ProcessListen (Ptr<Packet> packet, const TcpHeader& tcpHeader,
                              const Address& fromAddress, const Address& toAddress)
{
  ...
  Ptr<VirtualTcpSocketBase> newSock = Fork ();
  NS_LOG_LOGIC ("Cloned a VirtualTcpSocketBase " << newSock);
  Simulator::ScheduleNow (&VirtualTcpSocketBase::CompleteFork, newSock,
                          packet, tcpHeader, fromAddress, toAddress);
}

/* Received a packet upon SYN_SENT */
void
VirtualTcpSocketBase::ProcessSynSent (Ptr<Packet> packet, const TcpHeader& tcpHeader)
{
  NS_LOG_FUNCTION (this << tcpHeader);
  ...
  if (tcpflags == 0)
    { // Bare data, accept it and move to ESTABLISHED state. This is not a normal behaviour. Remove this?
      ...
      ReceivedData (packet, tcpHeader);
      Simulator::ScheduleNow (&VirtualTcpSocketBase::ConnectionSucceeded, this);
    }
...
void
VirtualTcpSocketBase::ProcessSynRcvd (Ptr<Packet> packet, const TcpHeader& tcpHeader,
                               const Address& fromAddress, const Address& toAddress)
{
  NS_UNUSED (toAddress);
  NS_LOG_FUNCTION (this << tcpHeader);
...
void
VirtualTcpSocketBase::ProcessWait (Ptr<Packet> packet, const TcpHeader& tcpHeader)
{
  NS_LOG_FUNCTION (this << tcpHeader);
...
void
VirtualTcpSocketBase::ProcessClosing (Ptr<Packet> packet, const TcpHeader& tcpHeader)
{
  NS_LOG_FUNCTION (this << tcpHeader);
...
void
VirtualTcpSocketBase::ProcessLastAck (Ptr<Packet> packet, const TcpHeader& tcpHeader)
{
  NS_LOG_FUNCTION (this << tcpHeader);
...
void
VirtualTcpSocketBase::PeerClose (Ptr<Packet> p, const TcpHeader& tcpHeader)
{
  NS_LOG_FUNCTION (this << tcpHeader);
...
void
VirtualTcpSocketBase::DoPeerClose (void)
{
  ...
  if (m_state == LAST_ACK)
    {
      NS_LOG_LOGIC ("VirtualTcpSocketBase " << this << " scheduling LATO1");
      Time lastRto = m_rtt->GetEstimate () + Max (m_clockGranularity, m_rtt->GetVariation () * 4);
      m_lastAckEvent = Simulator::Schedule (lastRto, &VirtualTcpSocketBase::LastAckTimeout, this);
    }
}
...
void
VirtualTcpSocketBase::Destroy (void)
{
  NS_LOG_FUNCTION (this);
  m_endPoint = nullptr;
  if (m_tcp != nullptr)
...
/* Kill this socket. This is a callback function configured to m_endpoint in
   SetupCallback(), invoked when the endpoint is destroyed. */
void
VirtualTcpSocketBase::Destroy6 (void)
{
  NS_LOG_FUNCTION (this);
  m_endPoint6 = nullptr;
  if (m_tcp != nullptr)
...
void
VirtualTcpSocketBase::SendEmptyPacket (uint8_t flags)
{
  ...
  if (m_retxEvent.IsExpired () && (hasSyn || hasFin) && !isAck )
    { // Retransmit SYN / SYN+ACK / FIN / FIN+ACK to guard against lost
      ...
      m_retxEvent = Simulator::Schedule (m_rto, &VirtualTcpSocketBase::SendEmptyPacket, this, flags);
    }
}

/* This function closes the endpoint completely. Called upon RST_TX action. */
void
VirtualTcpSocketBase::SendRST (void)
{
  NS_LOG_FUNCTION (this);
...
void
VirtualTcpSocketBase::DeallocateEndPoint (void)
{
  if (m_endPoint != nullptr)
    {
      CancelAllTimers ();
...
int
VirtualTcpSocketBase::SetupEndpoint ()
{
  NS_LOG_FUNCTION (this);
  Ptr<Ipv4> ipv4 = m_node->GetObject<VirtualIpv4L3Protocol> ();
...
/* This function is called only if a SYN received in LISTEN state. After
   VirtualTcpSocketBase cloned, allocate a new end point to handle the incoming
   connection and send a SYN+ACK to complete the handshake. */
void
VirtualTcpSocketBase::CompleteFork (Ptr<Packet> p, const TcpHeader& h,
                             const Address& fromAddress, const Address& toAddress)
{
...
void
VirtualTcpSocketBase::ConnectionSucceeded ()
...
void
VirtualTcpSocketBase::AddSocketTags (const Ptr<Packet> &p) const
{
  /*
...
/* Extract at most maxSize bytes from the TxBuffer at sequence seq, add the
    TCP header, and send to VirtualTcpL4Protocol */
uint32_t
VirtualTcpSocketBase::SendDataPacket (SequenceNumber32 seq, uint32_t maxSize, bool withAck)
{
  ...
  if (m_retxEvent.IsExpired ())
    {
      ...
      NS_LOG_LOGIC (this << " SendDataPacket Schedule ReTxTimeout at time " <<
                    Simulator::Now ().GetSeconds () << " to expire at time " <<
                    (Simulator::Now () + m_rto.Get ()).GetSeconds () );
      m_retxEvent = Simulator::Schedule (m_rto, &VirtualTcpSocketBase::ReTxTimeout, this);
    }
  ...
  if (m_endPoint)
    {
      ...
      NS_LOG_DEBUG ("Send segment of size " << sz << " with remaining data " <<
                    remainingData << " via VirtualTcpL4Protocol to " <<  m_endPoint->GetPeerAddress () <<
                    ". Header " << header);
    }
  else
    {
      m_tcp->SendPacket (p, header, m_endPoint6->GetLocalAddress (),
                         m_endPoint6->GetPeerAddress (), m_boundnetdevice);
      NS_LOG_DEBUG ("Send segment of size " << sz << " with remaining data " <<
                    remainingData << " via VirtualTcpL4Protocol to " <<  m_endPoint6->GetPeerAddress () <<
                    ". Header " << header);
    }
  ...
  if (seq + sz > m_tcb->m_highTxMark)
    {
      Simulator::ScheduleNow (&VirtualTcpSocketBase::NotifyDataSent, this,
...
void
VirtualTcpSocketBase::UpdateRttHistory (const SequenceNumber32 &seq, uint32_t sz,
...
uint32_t
VirtualTcpSocketBase::SendPendingData (bool withAck)
{
  ...
  if (m_endPoint == nullptr && m_endPoint6 == nullptr)
    {
      NS_LOG_INFO ("VirtualTcpSocketBase::SendPendingData: No endpoint; m_shutdownSend=" << m_shutdownSend);
...
uint32_t
VirtualTcpSocketBase::UnAckDataCount () const
{
  return m_tcb->m_highTxMark - m_txBuffer->HeadSequence ();
}

uint32_t
VirtualTcpSocketBase::BytesInFlight () const
{
...
uint32_t
VirtualTcpSocketBase::Window (void) const
{
  return std::min (m_rWnd.Get (), m_tcb->m_cWnd.Get ());
}

uint32_t
VirtualTcpSocketBase::AvailableWindow () const
{
...
uint16_t
VirtualTcpSocketBase::AdvertisedWindowSize (bool scale) const
{
  ...
  if (w != m_advWnd)
    {
      const_cast<VirtualTcpSocketBase*> (this)->m_advWnd = w;
    }
  if (scale)
    {
      w >>= m_rcvWindShift;
...
void
VirtualTcpSocketBase::ReceivedData (Ptr<Packet> p, const TcpHeader& tcpHeader)
{
  NS_LOG_FUNCTION (this << tcpHeader);
      ...
      if (++m_delAckCount >= m_delAckMaxCount)
      ...
      else if (m_delAckEvent.IsExpired ())
        {
          m_delAckEvent = Simulator::Schedule (m_delAckTimeout,
                                               &VirtualTcpSocketBase::DelAckTimeout, this);
 ...
 */
void
VirtualTcpSocketBase::EstimateRtt (const TcpHeader& tcpHeader)
{
...
void
VirtualTcpSocketBase::NewAck (SequenceNumber32 const& ack, bool resetRTO)
{
...
// Retransmit timeout
void
VirtualTcpSocketBase::ReTxTimeout ()
{
  NS_LOG_FUNCTION (this);
...
void
VirtualTcpSocketBase::DelAckTimeout (void)
{
  m_delAckCount = 0;
...
void
VirtualTcpSocketBase::LastAckTimeout (void)
{
  NS_LOG_FUNCTION (this);
...
void
VirtualTcpSocketBase::PersistTimeout ()
{
...
void
VirtualTcpSocketBase::DoRetransmit ()
{
  NS_LOG_FUNCTION (this);
  bool res;
...
void
VirtualTcpSocketBase::CancelAllTimers ()
{
  m_retxEvent.Cancel ();
  m_persistEvent.Cancel ();
  m_delAckEvent.Cancel ();
...
VirtualTcpSocketBase::TimeWait ()
{
  ...
  m_timewaitEvent = Simulator::Schedule (Seconds (2 * m_msl),
                                         &VirtualTcpSocketBase::CloseAndNotify, this);
}

/* Below are the attribute get/set functions */

void
VirtualTcpSocketBase::SetSndBufSize (uint32_t size)
{
...
uint32_t
VirtualTcpSocketBase::GetSndBufSize (void) const
{
  return m_txBuffer->MaxBufferSize ();
}

void
VirtualTcpSocketBase::SetRcvBufSize (uint32_t size)
{
  NS_LOG_FUNCTION (this << size);
...
uint32_t
VirtualTcpSocketBase::GetRcvBufSize (void) const
{
  return m_rxBuffer->MaxBufferSize ();
}

void
VirtualTcpSocketBase::SetSegSize (uint32_t size)
{
  NS_LOG_FUNCTION (this << size);
...
uint32_t
VirtualTcpSocketBase::GetSegSize (void) const
{
  return m_tcb->m_segmentSize;
}

void
VirtualTcpSocketBase::SetConnTimeout (Time timeout)
{
...
Time
VirtualTcpSocketBase::GetConnTimeout (void) const
{
  return m_cnTimeout;
}

void
VirtualTcpSocketBase::SetSynRetries (uint32_t count)
{
...
uint32_t
VirtualTcpSocketBase::GetSynRetries (void) const
{
  return m_synRetries;
}

void
VirtualTcpSocketBase::SetDataRetries (uint32_t retries)
{
...
uint32_t
VirtualTcpSocketBase::GetDataRetries (void) const
{
  NS_LOG_FUNCTION (this);
...
void
VirtualTcpSocketBase::SetDelAckTimeout (Time timeout)
{
  NS_LOG_FUNCTION (this << timeout);
...
Time
VirtualTcpSocketBase::GetDelAckTimeout (void) const
{
  return m_delAckTimeout;
}

void
VirtualTcpSocketBase::SetDelAckMaxCount (uint32_t count)
{
  NS_LOG_FUNCTION (this << count);
...
uint32_t
VirtualTcpSocketBase::GetDelAckMaxCount (void) const
{
  return m_delAckMaxCount;
}

void
VirtualTcpSocketBase::SetTcpNoDelay (bool noDelay)
{
...
bool
VirtualTcpSocketBase::GetTcpNoDelay (void) const
{
  return m_noDelay;
}

void
VirtualTcpSocketBase::SetPersistTimeout (Time timeout)
{
  NS_LOG_FUNCTION (this << timeout);
...
Time
VirtualTcpSocketBase::GetPersistTimeout (void) const
{
  return m_persistTimeout;
}

bool
VirtualTcpSocketBase::SetAllowBroadcast (bool allowBroadcast)
{
...
bool
VirtualTcpSocketBase::GetAllowBroadcast (void) const
{
  return false;
}

void
VirtualTcpSocketBase::AddOptions (TcpHeader& header)
{
...
void
VirtualTcpSocketBase::ProcessOptionWScale (const Ptr<const TcpOption> option)
{
...
uint8_t
VirtualTcpSocketBase::CalculateWScale () const
{
  NS_LOG_FUNCTION (this);
...
void
VirtualTcpSocketBase::AddOptionWScale (TcpHeader &header)
{
  NS_LOG_FUNCTION (this << header);
...
bool
VirtualTcpSocketBase::ProcessOptionSack (const Ptr<const TcpOption> option)
{
  NS_LOG_FUNCTION (this << option);
...
void
VirtualTcpSocketBase::ProcessOptionSackPermitted (const Ptr<const TcpOption> option)
{
  NS_LOG_FUNCTION (this << option);
...
void
VirtualTcpSocketBase::AddOptionSackPermitted (TcpHeader &header)
{
  NS_LOG_FUNCTION (this << header);
  NS_ASSERT (header.GetFlags () & TcpHeader::SYN);
...
void
VirtualTcpSocketBase::AddOptionSack (TcpHeader& header)
{
  NS_LOG_FUNCTION (this << header);
...
void
VirtualTcpSocketBase::ProcessOptionTimestamp (const Ptr<const TcpOption> option,
...
void
VirtualTcpSocketBase::AddOptionTimestamp (TcpHeader& header)
{
  NS_LOG_FUNCTION (this << header);
...
void VirtualTcpSocketBase::UpdateWindowSize (const TcpHeader &header)
{
  NS_LOG_FUNCTION (this << header);
...
void
VirtualTcpSocketBase::SetMinRto (Time minRto)
{
...
Time
VirtualTcpSocketBase::GetMinRto (void) const
{
  return m_minRto;
}

void
VirtualTcpSocketBase::SetClockGranularity (Time clockGranularity)
{
...
Time
VirtualTcpSocketBase::GetClockGranularity (void) const
{
  return m_clockGranularity;
}

Ptr<TcpTxBuffer>
VirtualTcpSocketBase::GetTxBuffer (void) const
{
  return m_txBuffer;
}

Ptr<TcpRxBuffer>
VirtualTcpSocketBase::GetRxBuffer (void) const
{
  return m_rxBuffer;
}

void
VirtualTcpSocketBase::SetRetxThresh (uint32_t retxThresh)
{
...
void
VirtualTcpSocketBase::UpdateCwnd (uint32_t oldValue, uint32_t newValue)
{
  m_cWndTrace (oldValue, newValue);
}

void
VirtualTcpSocketBase::UpdateCwndInfl (uint32_t oldValue, uint32_t newValue)
{
  m_cWndInflTrace (oldValue, newValue);
}

void
VirtualTcpSocketBase::UpdateSsThresh (uint32_t oldValue, uint32_t newValue)
{
  m_ssThTrace (oldValue, newValue);
}

void
VirtualTcpSocketBase::UpdateCongState (TcpSocketState::TcpCongState_t oldValue,
                                TcpSocketState::TcpCongState_t newValue)
{
 ...
 void
VirtualTcpSocketBase::UpdateEcnState (TcpSocketState::EcnState_t oldValue,
...
void
VirtualTcpSocketBase::UpdateNextTxSequence (SequenceNumber32 oldValue,
...
void
VirtualTcpSocketBase::UpdateHighTxMark (SequenceNumber32 oldValue, SequenceNumber32 newValue)
{
  m_highTxMarkTrace (oldValue, newValue);
}

void
VirtualTcpSocketBase::UpdateBytesInFlight (uint32_t oldValue, uint32_t newValue)
{
  m_bytesInFlightTrace (oldValue, newValue);
}

void
VirtualTcpSocketBase::UpdateRtt (Time oldValue, Time newValue)
{
  m_lastRttTrace (oldValue, newValue);
}

void
VirtualTcpSocketBase::SetCongestionControlAlgorithm (Ptr<TcpCongestionOps> algo)
{
...
void
VirtualTcpSocketBase::SetRecoveryAlgorithm (Ptr<TcpRecoveryOps> recovery)
{
  NS_LOG_FUNCTION (this << recovery);
  m_recoveryOps = recovery;
}

Ptr<VirtualTcpSocketBase>
VirtualTcpSocketBase::Fork (void)
{
  return CopyObject<VirtualTcpSocketBase> (this);
}

uint32_t
VirtualTcpSocketBase::SafeSubtraction (uint32_t a, uint32_t b)
{
  if (a > b)
    {
      return a-b;
...
void
VirtualTcpSocketBase::NotifyPacingPerformed (void)
{
...
void
VirtualTcpSocketBase::SetEcn (EcnMode_t ecnMode)
{
  NS_LOG_FUNCTION (this);
  m_ecnMode = ecnMode;
}
