...
NS_LOG_COMPONENT_DEFINE ("VirtualIpv6L3Protocol");

NS_OBJECT_ENSURE_REGISTERED (VirtualIpv6L3Protocol);

const uint16_t VirtualIpv6L3Protocol::PROT_NUMBER = 0x86DD;

TypeId VirtualIpv6L3Protocol::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::VirtualIpv6L3Protocol")
    .SetParent<Ipv6> ()
    .SetGroupName ("Internet")
    .AddConstructor<VirtualIpv6L3Protocol> ()
    .AddAttribute ("DefaultTtl",
                   "The TTL value set by default on all "
                   "outgoing packets generated on this node.",
                   UintegerValue (64),
                   MakeUintegerAccessor (&VirtualIpv6L3Protocol::m_defaultTtl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DefaultTclass",
                   "The TCLASS value set by default on all "
                   "outgoing packets generated on this node.",
                   UintegerValue (0),
                   MakeUintegerAccessor (&VirtualIpv6L3Protocol::m_defaultTclass),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("InterfaceList",
                   "The set of IPv6 interfaces associated to this IPv6 stack.",
                   ObjectVectorValue (),
                   MakeObjectVectorAccessor (&VirtualIpv6L3Protocol::m_interfaces),
                   MakeObjectVectorChecker<Ipv6Interface> ())
    .AddAttribute ("SendIcmpv6Redirect",
                   "Send the ICMPv6 Redirect when appropriate.",
                   BooleanValue (true),
                   MakeBooleanAccessor (&VirtualIpv6L3Protocol::SetSendIcmpv6Redirect,
                                        &VirtualIpv6L3Protocol::GetSendIcmpv6Redirect),
                   MakeBooleanChecker ())
    .AddAttribute ("StrongEndSystemModel",
                   ...
                   BooleanValue (true),
                   MakeBooleanAccessor (&VirtualIpv6L3Protocol::m_strongEndSystemModel),
                   MakeBooleanChecker ())
    .AddTraceSource ("Tx",
                     "Send IPv6 packet to outgoing interface.",
                     MakeTraceSourceAccessor (&VirtualIpv6L3Protocol::m_txTrace),
                     "ns3::VirtualIpv6L3Protocol::TxRxTracedCallback")
    .AddTraceSource ("Rx",
                     "Receive IPv6 packet from incoming interface.",
                     MakeTraceSourceAccessor (&VirtualIpv6L3Protocol::m_rxTrace),
                     "ns3::VirtualIpv6L3Protocol::TxRxTracedCallback")
    .AddTraceSource ("Drop",
                     "Drop IPv6 packet",
                     MakeTraceSourceAccessor (&VirtualIpv6L3Protocol::m_dropTrace),
                     "ns3::VirtualIpv6L3Protocol::DropTracedCallback")

    .AddTraceSource ("SendOutgoing",
                     "A newly-generated packet by this node is "
                     "about to be queued for transmission",
                     MakeTraceSourceAccessor (&VirtualIpv6L3Protocol::m_sendOutgoingTrace),
                     "ns3::VirtualIpv6L3Protocol::SentTracedCallback")
    .AddTraceSource ("UnicastForward",
                     "A unicast IPv6 packet was received by this node "
                     "and is being forwarded to another node",
                     MakeTraceSourceAccessor (&VirtualIpv6L3Protocol::m_unicastForwardTrace),
                     "ns3::VirtualIpv6L3Protocol::SentTracedCallback")
    .AddTraceSource ("LocalDeliver",
                     "An IPv6 packet was received by/for this node, "
                     "and it is being forward up the stack",
                     MakeTraceSourceAccessor (&VirtualIpv6L3Protocol::m_localDeliverTrace),
                     "ns3::VirtualIpv6L3Protocol::SentTracedCallback")
  ;
  return tid;
}

VirtualIpv6L3Protocol::VirtualIpv6L3Protocol ()
  : m_nInterfaces (0)
{
...
void VirtualIpv6L3Protocol::DoDispose ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
void VirtualIpv6L3Protocol::SetRoutingProtocol (Ptr<Ipv6RoutingProtocol> routingProtocol)
{
...
Ptr<Ipv6RoutingProtocol> VirtualIpv6L3Protocol::GetRoutingProtocol () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_routingProtocol;
}

uint32_t VirtualIpv6L3Protocol::AddInterface (Ptr<NetDevice> device)
{
  ...
  m_node->RegisterProtocolHandler (MakeCallback (&TrafficControlLayer::Receive, tc),
                                   VirtualIpv6L3Protocol::PROT_NUMBER, device);

  tc->RegisterProtocolHandler (MakeCallback (&VirtualIpv6L3Protocol::Receive, this),
                               VirtualIpv6L3Protocol::PROT_NUMBER, device);
...
uint32_t VirtualIpv6L3Protocol::AddIpv6Interface (Ptr<Ipv6Interface> interface)
{
...
Ptr<Ipv6Interface> VirtualIpv6L3Protocol::GetInterface (uint32_t index) const
{
...
uint32_t VirtualIpv6L3Protocol::GetNInterfaces () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_nInterfaces;
}

int32_t VirtualIpv6L3Protocol::GetInterfaceForAddress (Ipv6Address address) const
{
...
int32_t VirtualIpv6L3Protocol::GetInterfaceForPrefix (Ipv6Address address, Ipv6Prefix mask) const
{
...
Ptr<NetDevice> VirtualIpv6L3Protocol::GetNetDevice (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  return GetInterface (i)->GetDevice ();
}

int32_t VirtualIpv6L3Protocol::GetInterfaceForDevice (Ptr<const NetDevice> device) const
{
  NS_LOG_FUNCTION (this << device);
...
void VirtualIpv6L3Protocol::AddAutoconfiguredAddress (uint32_t interface, Ipv6Address network, Ipv6Prefix mask, uint8_t flags, uint32_t validTime, uint32_t preferredTime, Ipv6Address defaultRouter)
{
  ...
  if (flags & (1 << 6)) /* auto flag */
    {
      // In case of new MacAddress types, remember to change VirtualIpv6L3Protocol::RemoveAutoconfiguredAddress as well
...
void VirtualIpv6L3Protocol::RemoveAutoconfiguredAddress (uint32_t interface, Ipv6Address network, Ipv6Prefix mask, Ipv6Address defaultRouter)
{
...
bool VirtualIpv6L3Protocol::AddAddress (uint32_t i, Ipv6InterfaceAddress address)
{
...
uint32_t VirtualIpv6L3Protocol::GetNAddresses (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv6Interface> interface = GetInterface (i);
...
Ipv6InterfaceAddress VirtualIpv6L3Protocol::GetAddress (uint32_t i, uint32_t addressIndex) const
{
...
bool VirtualIpv6L3Protocol::RemoveAddress (uint32_t i, uint32_t addressIndex)
{
  NS_LOG_FUNCTION (this << i << addressIndex);
  Ptr<Ipv6Interface> interface = GetInterface (i);
...
bool 
VirtualIpv6L3Protocol::RemoveAddress (uint32_t i, Ipv6Address address)
{
  NS_LOG_FUNCTION (this << i << address);
...
void VirtualIpv6L3Protocol::SetMetric (uint32_t i, uint16_t metric)
{
...
uint16_t VirtualIpv6L3Protocol::GetMetric (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv6Interface> interface = GetInterface (i);
...
uint16_t VirtualIpv6L3Protocol::GetMtu (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
...
void VirtualIpv6L3Protocol::SetPmtu (Ipv6Address dst, uint32_t pmtu)
{
...
bool VirtualIpv6L3Protocol::IsUp (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv6Interface> interface = GetInterface (i);
...
void VirtualIpv6L3Protocol::SetUp (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv6Interface> interface = GetInterface (i);
...
void VirtualIpv6L3Protocol::SetDown (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv6Interface> interface = GetInterface (i);
...
void VirtualIpv6L3Protocol::SetupLoopback ()
{
  NS_LOG_FUNCTION_NOARGS ();
  Ptr<Ipv6Interface> interface = CreateObject<Ipv6Interface> ();
  ...
  node->RegisterProtocolHandler (MakeCallback (&VirtualIpv6L3Protocol::Receive, this), VirtualIpv6L3Protocol::PROT_NUMBER, device);
  interface->SetUp ();
...
bool VirtualIpv6L3Protocol::IsForwarding (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv6Interface> interface = GetInterface (i);
...
void VirtualIpv6L3Protocol::SetForwarding (uint32_t i, bool val)
{
...
Ipv6Address VirtualIpv6L3Protocol::SourceAddressSelection (uint32_t interface, Ipv6Address dest)
{
...
void VirtualIpv6L3Protocol::SetIpForward (bool forward)
{
...
bool VirtualIpv6L3Protocol::GetIpForward () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_ipForward;
}

void VirtualIpv6L3Protocol::SetMtuDiscover (bool mtuDiscover)
{
  NS_LOG_FUNCTION (this << int(mtuDiscover));
  m_mtuDiscover = mtuDiscover;
}

bool VirtualIpv6L3Protocol::GetMtuDiscover () const
{
  NS_LOG_FUNCTION (this);
  return m_mtuDiscover;
}

void VirtualIpv6L3Protocol::SetSendIcmpv6Redirect (bool sendIcmpv6Redirect)
{
  NS_LOG_FUNCTION (this << sendIcmpv6Redirect);
  m_sendIcmpv6Redirect = sendIcmpv6Redirect;
}

bool VirtualIpv6L3Protocol::GetSendIcmpv6Redirect () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_sendIcmpv6Redirect;
}

void VirtualIpv6L3Protocol::NotifyNewAggregate ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
void VirtualIpv6L3Protocol::SetNode (Ptr<Node> node)
{
...
void VirtualIpv6L3Protocol::Insert (Ptr<IpL4Protocol> protocol)
{
...
void VirtualIpv6L3Protocol::Insert (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
...
void VirtualIpv6L3Protocol::Remove (Ptr<IpL4Protocol> protocol)
{
  NS_LOG_FUNCTION (this << protocol);
...
void VirtualIpv6L3Protocol::Remove (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
  NS_LOG_FUNCTION (this << protocol << interfaceIndex);
...
Ptr<IpL4Protocol> VirtualIpv6L3Protocol::GetProtocol (int protocolNumber) const
{
...
Ptr<IpL4Protocol> VirtualIpv6L3Protocol::GetProtocol (int protocolNumber, int32_t interfaceIndex) const
{
...
Ptr<Socket> VirtualIpv6L3Protocol::CreateRawSocket ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
void VirtualIpv6L3Protocol::DeleteRawSocket (Ptr<Socket> socket)
{
...
Ptr<Icmpv6L4Protocol> VirtualIpv6L3Protocol::GetIcmpv6 () const
{
  NS_LOG_FUNCTION_NOARGS ();
...
void VirtualIpv6L3Protocol::SetDefaultTtl (uint8_t ttl)
{
  NS_LOG_FUNCTION (this << ttl);
  m_defaultTtl = ttl;
}

void VirtualIpv6L3Protocol::SetDefaultTclass (uint8_t tclass)
{
  NS_LOG_FUNCTION (this << tclass);
  m_defaultTclass = tclass;
}

void VirtualIpv6L3Protocol::Send (Ptr<Packet> packet, Ipv6Address source, Ipv6Address destination, uint8_t protocol, Ptr<Ipv6Route> route)
{
  ...
  if (route && route->GetGateway () != Ipv6Address::GetZero ())
    {
      NS_LOG_LOGIC ("VirtualIpv6L3Protocol::Send case 1: passed in with a route");
  ...
  if (route && route->GetGateway () == Ipv6Address::GetZero ())
    {
      NS_LOG_LOGIC ("VirtualIpv6L3Protocol::Send case 1: probably sent to machine on same IPv6 network");
  ...
  /* 3) */
  NS_LOG_LOGIC ("VirtualIpv6L3Protocol::Send case 3: passed in with no route " << destination);
...
void VirtualIpv6L3Protocol::Receive (Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol, const Address &from, const Address &to, NetDevice::PacketType packetType)
{
  ...
  if (!m_routingProtocol->RouteInput (packet, hdr, device,
                                      MakeCallback (&VirtualIpv6L3Protocol::IpForward, this),
                                      MakeCallback (&VirtualIpv6L3Protocol::IpMulticastForward, this),
                                      MakeCallback (&VirtualIpv6L3Protocol::LocalDeliver, this),
                                      MakeCallback (&VirtualIpv6L3Protocol::RouteInputError, this)))
    {
...
void
VirtualIpv6L3Protocol::CallTxTrace (const Ipv6Header & ipHeader, Ptr<Packet> packet,
...
void VirtualIpv6L3Protocol::SendRealOut (Ptr<Ipv6Route> route, Ptr<Packet> packet, Ipv6Header const& ipHeader)
{
...
void VirtualIpv6L3Protocol::IpForward (Ptr<const NetDevice> idev, Ptr<Ipv6Route> rtentry, Ptr<const Packet> p, const Ipv6Header& header)
{
...
void VirtualIpv6L3Protocol::IpMulticastForward (Ptr<const NetDevice> idev, Ptr<Ipv6MulticastRoute> mrtentry, Ptr<const Packet> p, const Ipv6Header& header)
{
...
void VirtualIpv6L3Protocol::LocalDeliver (Ptr<const Packet> packet, Ipv6Header const& ip, uint32_t iif)
{
...
void VirtualIpv6L3Protocol::RouteInputError (Ptr<const Packet> p, const Ipv6Header& ipHeader, Socket::SocketErrno sockErrno)
{
...
Ipv6Header VirtualIpv6L3Protocol::BuildHeader (Ipv6Address src, Ipv6Address dst, uint8_t protocol, uint16_t payloadSize, uint8_t ttl, uint8_t tclass)
{
...
void VirtualIpv6L3Protocol::RegisterExtensions ()
{
...
void VirtualIpv6L3Protocol::RegisterOptions ()
{
...
void VirtualIpv6L3Protocol::ReportDrop (Ipv6Header ipHeader, Ptr<Packet> p, DropReason dropReason)
{
  m_dropTrace (ipHeader, p, dropReason, m_node->GetObject<Ipv6> (), 0);
}

void VirtualIpv6L3Protocol::AddMulticastAddress (Ipv6Address address, uint32_t interface)
{
...
void VirtualIpv6L3Protocol::AddMulticastAddress (Ipv6Address address)
{
...
void VirtualIpv6L3Protocol::RemoveMulticastAddress (Ipv6Address address, uint32_t interface)
{
  NS_LOG_FUNCTION (address << interface);
...
void VirtualIpv6L3Protocol::RemoveMulticastAddress (Ipv6Address address)
{
  NS_LOG_FUNCTION (address);
...
bool VirtualIpv6L3Protocol::IsRegisteredMulticastAddress (Ipv6Address address, uint32_t interface) const
{
  NS_LOG_FUNCTION (address << interface);
...
bool VirtualIpv6L3Protocol::IsRegisteredMulticastAddress (Ipv6Address address) const
{
  NS_LOG_FUNCTION (address);
