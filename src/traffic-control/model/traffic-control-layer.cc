...
*/
void
TrafficControlLayer::DeliverToL3 (Ptr<Packet> p, 
                      Ipv4Address source,
...
*/
void
TrafficControlLayer::SetDownTarget (IpL4Protocol::DownTargetCallback callback)
{
...
TrafficControlLayer::GetDownTarget (void) const
{
  NS_LOG_FUNCTION (this);
  return m_downTarget;
}
